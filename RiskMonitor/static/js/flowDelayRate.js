$(document).ready(function(){
    ...
    $.get("../api/index?format=json&table=flowdelayrate&content=item&fundName=" + fundId,function(dataset){
    ...
    $.get("../api/index?format=json&table=flowdelayrateno&content=item&fundName=" + fundId,function(dataset){
        console.log(dataset)
